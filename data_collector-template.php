				...
				<form>
					<div class="wrapper">
						<div class="multipart-section" data-position="1">
							...
							<a href="" class="snwb-next">Continue</a>
						</div>
						<div class="multipart-section" data-position="2">
							<div class="form-element">
								<label>Your gender (because math)</label>
								<input type="radio" name="gender" value="female" data-validate="optional"><label class="radio-label" for="female">Female</label><br>
								<input type="radio" name="gender" value="male" data-validate="optional"><label class="radio-label" for="male">Male</label><br>
								<input type="radio" name="gender" value="non-binary" data-validate="optional"><label class="radio-label" for="non-binary">Non Binary</label>
							</div>
							<div class="form-element">
